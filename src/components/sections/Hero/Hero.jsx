        ...
        >
          ...
          <div className="lg:col-span-2 space-y-8">
            <motion.div variants={titleVariants} className="space-y-4">
               <figure>
                <img
                    ...
                    alt={`${HERO_CONTENT.name}'s profile picture`} 
                    className="w-100 h-auto rounded-full mt-5 shadow-lg" 
                />
              </figure>
              
              <h1
                className={`text-5xl md:text-7xl font-bold leading-tight bg-gradient-to-r bg-clip-text text-transparent ${
                  currentTheme === "minimal"
              ...
              <div
                className={`text-2xl md:text-3xl font-medium h-12 flex items-center ${
                  currentTheme === "minimal"
                    ? "text-gray-700"
                    : "text-purple-300"
                }`}
            ...
            >
              <Button
                as="a"
                href='https://drive.google.com/file/d/11Ik49GWD7VysGTHj74pjGjnH0N_0ZapF/view?usp=sharing'
                variant="primary"
                size="lg"
                loading={isLoading}
                className="group"
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <motion.a
                  href="https://www.linkedin.com/in/fahmida--rahman/"
                  target="_blank"
